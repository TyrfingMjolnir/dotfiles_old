sudo pacman -S exa tmux tidy vim ctags curl rxvt-unicode mpv youtube-dl couchdb redis postgresql orientdb ttf-inconsolata
yaourt -S nvm firefox-aurora qira
